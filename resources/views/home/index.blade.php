...
<main id="MainContent" class="content-for-layout focus-none" role="main" tabindex="-1">
    <section id="shopify-section-template--17918930681993__image_banner" class="shopify-section section">
        <link href="{{asset('css/section-image-banner.css?v=124819179385751388401739714003')}}" rel="stylesheet" type="text/css" media="all" />
        <style data-shopify>
                ...
                <svg class="placeholder-svg" preserveAspectRatio="xMaxYMid slice" viewBox="0 0 1300 730" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_779_1238)">
                        ...
                        <path
                            ...
                            fill="#142924"
                        />
                        <path d="M863.006 501.368c4.692-5.373 10.126-9.885 15.994-13.368-6.919 1.213-13.739 3.892-19.93 7.953-18.361 12-32.493 29.585-40.07 49.397L834.35 559c4.314-20.94 14.16-41.035 28.656-57.618v-.014Z" fill="#00735C" />
                        <path
                        ...
                        <path
                            ...
                            fill="#CD5747"
                        />
                        <path d="m1016.92 560.014-3.44 10.32a9.342 9.342 0 0 0 4.04 10.964c8.09 4.899 20.37 10.238 30.03 12.461 4.07.947 8.27-.961 10.32-4.57l5.13-8.989c-15.69-1.825-36.49-10.127-46.06-20.2l-.02.014Z" fill="#F7E1D5" />
                        <path
            ...
            <div class="banner__content banner__content--bottom-center page-width scroll-trigger animate--slide-in">
                <div class="banner__box content-container content-container--full-width-mobile color-scheme-3 gradient">
                    <h2 class="banner__heading inline-richtext h0">
                        আমাদের সর্বশেষ পণ্য ব্রাউজ করুন
                    </h2>
                                ...
                                <div class="card__inner color-scheme-2 gradient ratio" style="--ratio-percent: 133.33333333333334%;">
                                    <div class="card__media">
                                        <div class="media media--transparent media--hover-effect">
                                            <img
                                                ...
                                                alt="চায়না ল্যাকার স্টিচ ফ্যাব্রিক"
                                                class="motion-reduce"
                                                loading="lazy"
                                                width="720"
                                                height="960"
                                    ...
                                    <div class="card__content">
                                        ...
                                        <div class="card__badge bottom left">
                                            <span id="NoMediaStandardBadge-template--17918930681993__featured_collection-8006034456713" class="badge badge--bottom-left color-scheme-4">ছাড়</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="card__content">
                                                    ...
                                                    <div class="price__sale">
                                                        ...
                                                        <span>
                                                            <s class="price-item price-item--regular">
                                                                টাকা {{ get_field('old_price','price',$product->id,'') }} BDT
                                                            </s>
                                                        </span>
