...
@section('content')
    ...
    @include('include.header')
        ...
        <main id="MainContent" class="content-for-layout focus-none" role="main" tabindex="-1">
            <section id="shopify-section-template--17918930681993__image_banner" class="shopify-section section">
                <link href="//qualitifashion.com/cdn/shop/t/1/assets/section-image-banner.css?v=124819179385751388401739714003" rel="stylesheet" type="text/css" media="all" />
                <style data-shopify>
                    #Banner-template--17918930681993__image_banner::after {
                        opacity: 0.4;
                    }
                </style>
                <div id="Banner-template--17918930681993__image_banner" class="banner banner--content-align-center banner--content-align-mobile-center banner--large banner--desktop-transparent scroll-trigger animate--fade-in">
                    <div class="banner__media media placeholder scroll-trigger animate--fade-in">
                        <svg class="placeholder-svg" preserveAspectRatio="xMaxYMid slice" viewBox="0 0 1300 730" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_779_1238)">
                                <path d="M1300 410H0v320h1300V410Z" fill="#5BA7B1" />
                                <path d="M1300 0H0v410h1300V0Z" fill="#E8BE9E" />
                                <path d="M474 410c28.51-39.81 73.78-89.8 142-120 113.63-50.31 194.66-3.1 266-52 41.04-28.12 81.7-89.98 80-238h338v410H474Z" fill="#EDAB8E" />
                                <path d="M1174 0c-4.57 45.64-17.01 110.48-52 180-69.25 137.58-182.37 205.13-230 230h408V0h-126Z" fill="#EA9A81" />
                                <path d="M126 410c124.14 0 213.59-14.83 242-66 38.93-70.13-74.2-158.33-34-262 15.92-41.06 49.03-66.82 74-82H0v410h126Z" fill="#EDAB8E" />
                                <path d="M126 410c-68.88-117.13-69.26-250.08-2-334 36.03-44.96 83.52-65.93 116-76H0v410h126Z" fill="#EA9A81" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="#EAD1C1"
                                />
                                <path d="m980 410 73.94-92.43a55.18 55.18 0 0 1 35.49-20.18l33.63-4.67a55.168 55.168 0 0 0 37.31-22.58l35.94-50.31c8.42-11.79 25.37-13.3 35.75-3.19l67.94 66.24V410H980Z" fill="#9FA5AB" />
                                <path
                                    opacity=".3"
                                ...
                                <path
                                    ...
                                    fill="#02614E"
                                />
                                <path d="M0 410h218l-9.65-26.54a39.431 39.431 0 0 0-23.85-23.68l-51.05-18.15a39.436 39.436 0 0 1-25.57-30.02L102 279.66a39.44 39.44 0 0 0-24.53-29.63L0 220v190Z" fill="#686E72" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="#02614E"
                                />
                                <path d="M576 186c35.346 0 64-28.654 64-64 0-35.346-28.654-64-64-64-35.346 0-64 28.654-64 64 0 35.346 28.654 64 64 64Z" fill="#EAD1C1" />
                                <path d="M576 170c26.51 0 48-21.49 48-48s-21.49-48-48-48-48 21.49-48 48 21.49 48 48 48Z" fill="#fff" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="#964F48"
                                />
                                <path d="m695.71 113.63 12.93 12.86a8.834 8.834 0 0 0 9 2.13l16.46-5.4c1.9-.62 1.46-3.42-.54-3.43l-14.37-.06c-3.08-.01-6.12-.77-8.85-2.19l-12.65-6.6c-1.72-.9-3.35 1.33-1.98 2.7v-.01Z" fill="#964F48" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="#3C7980"
                                />
                                <path d="M819.933 546c-1.406 3.619-2.617 7.307-3.55 11.063L797 635h29.492L857 572.915 819.947 546h-.014Z" fill="#E8BE9E" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="#AF5947"
                                />
                                <path d="M973.436 592.368c-.621-16.691-4.045-32.654-9.993-47.368L934 574.442 951.167 635H975l-1.579-42.632h.015Z" fill="#E8BE9E" />
                                <path d="M969 559.741c-1.419-5.037-3.082-9.964-5.059-14.741L934 574.442 951.457 635h15.665l-12.598-43.703c-2.408-8.359 0-17.322 6.307-23.526l8.155-8.016.014-.014Z" fill="#EA9A81" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="#975D48"
                                />
                                <path opacity=".5" d="M1131.49 470.042 1148 473c-4.98-5.792-8.26-14.926-7.59-21.265l4.95-37.013-6.6-10.722-11.98 45.078c-1.95 7.326-.18 15.117 4.73 20.951l-.02.013Z" fill="#6D493C" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="#6B7177"
                                />
                                <path d="M1217 571.844 1249.18 541l39.82 86.272-33.9 2.728-38.1-58.156ZM1056 584.222 1017.4 562a1983.872 1983.872 0 0 0-23.4 95.638c10.25 3.375 20.39 6.833 29.06 10.362l32.93-83.778h.01Z" fill="#975D48" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="#F7E1D5"
                                />
                                <path d="m1063 639 11.11-8.488c9.33-17.356 11.3-40.094 9.03-61.118-.74-6.9-9.93-8.797-13.43-2.796l-1.71 2.923-5 69.479Z" fill="#CD5747" />
                                <path
                            ...
                            <defs>
                                <clipPath id="clip0_779_1238"><path fill="#fff" d="M0 0h1300v730H0z" /></clipPath>
                            </defs>
                        </svg>
                    </div>
                    <div class="banner__content banner__content--bottom-center page-width scroll-trigger animate--slide-in">
                        <div class="banner__box content-container content-container--full-width-mobile color-scheme-3 gradient">
                            ...
                            <div class="banner__buttons"><a href="/collections/all" class="button button--secondary">Shop all</a></div>
                        </div>
                    </div>
                </div>
            </section>
            <section id="shopify-section-template--17918930681993__featured_collection" class="shopify-section section">
                ...
                <link href="//qualitifashion.com/cdn/shop/t/1/assets/template-collection.css?v=58558206033505836701739714003" rel="stylesheet" type="text/css" media="all" />
                        ...
                        <slider-component class="slider-mobile-gutter page-width page-width-desktop scroll-trigger animate--slide-in">
                            ...
                            >
                                <li id="Slide-template--17918930681993__featured_collection-1" class="grid__item scroll-trigger animate--slide-in" data-cascade style="--animation-order: 1;">
                                    ...
                                    <link href="//qualitifashion.com/cdn/shop/t/1/assets/component-volume-pricing.css?v=111870094811454961941739714001" rel="stylesheet" type="text/css" media="all" />

                                    <link href="//qualitifashion.com/cdn/shop/t/1/assets/component-price.css?v=70172745017360139101739714001" rel="stylesheet" type="text/css" media="all" />
                                    <link href="//qualitifashion.com/cdn/shop/t/1/assets/quick-order-list.css?v=129932180309343703061739714003" rel="stylesheet" type="text/css" media="all" />
                                    ...
                                    <div class="card-wrapper product-card-wrapper underline-links-hover">
                                        <div class="card card--standard card--media" style="--ratio-percent: 133.33333333333334%;">
                                            <div class="card__inner color-scheme-2 gradient ratio" style="--ratio-percent: 133.33333333333334%;">
                                                <div class="card__media">
                                                    <div class="media media--transparent media--hover-effect">
                                                        <img
                                                            srcset="
                                                                //qualitifashion.com/cdn/shop/files/5x.jpg?v=1740077493&width=165 165w,
                                                                //qualitifashion.com/cdn/shop/files/5x.jpg?v=1740077493&width=360 360w,
                                                                //qualitifashion.com/cdn/shop/files/5x.jpg?v=1740077493&width=533 533w,
                                                                //qualitifashion.com/cdn/shop/files/5x.jpg?v=1740077493&width=720 720w,
                                                                //qualitifashion.com/cdn/shop/files/5x.jpg?v=1740077493           720w
                                                            "
                                                            src="//qualitifashion.com/cdn/shop/files/5x.jpg?v=1740077493&width=533"
                                                        ...
                                                        <img
                                                            srcset="
                                                                //qualitifashion.com/cdn/shop/files/1x.jpg?v=1740077514&width=165 165w,
                                                                //qualitifashion.com/cdn/shop/files/1x.jpg?v=1740077514&width=360 360w,
                                                                //qualitifashion.com/cdn/shop/files/1x.jpg?v=1740077514&width=533 533w,
                                                                //qualitifashion.com/cdn/shop/files/1x.jpg?v=1740077514&width=720 720w,
                                                                //qualitifashion.com/cdn/shop/files/1x.jpg?v=1740077514           720w
                                                            "
                                                            src="//qualitifashion.com/cdn/shop/files/1x.jpg?v=1740077514&width=533"
                                                            sizes="(min-width: 1200px) 267px, (min-width: 990px) calc((100vw - 130px) / 4), (min-width: 750px) calc((100vw - 120px) / 3), calc((100vw - 35px) / 2)"
                                                            alt=""
                                                            class="motion-reduce"
                                                            loading="lazy"
                                                ...
                                                <div class="card__content">
                                                    <div class="card__information">
                                                        <h3 class="card__heading">
                                                            <a
                                                                href="/products/china-lacra-stitch-fabric"
                                            ...
                                            <div class="card__content">
                                                ...
                                                <div class="card__badge bottom left"><span id="Badge-template--17918930681993__featured_collection-8006034456713" class="badge badge--bottom-left color-scheme-4">Sale</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li id="Slide-template--17918930681993__featured_collection-2" class="grid__item scroll-trigger animate--slide-in" data-cascade style="--animation-order: 2;">
                                    <div class="card-wrapper product-card-wrapper underline-links-hover">
                                        <div class="card card--standard card--media" style="--ratio-percent: 114.28571428571428%;">
                                            <div class="card__inner color-scheme-2 gradient ratio" style="--ratio-percent: 114.28571428571428%;">
                                                <div class="card__media">
                                                    <div class="media media--transparent media--hover-effect">
                                                        <img
                                                            srcset="
                                                                //qualitifashion.com/cdn/shop/files/Black-Color-4.webp?v=1741287346&width=165 165w,
                                                                //qualitifashion.com/cdn/shop/files/Black-Color-4.webp?v=1741287346&width=360 360w,
                                                                //qualitifashion.com/cdn/shop/files/Black-Color-4.webp?v=1741287346&width=533 533w,
                                                                //qualitifashion.com/cdn/shop/files/Black-Color-4.webp?v=1741287346           700w
                                                            "
                                                            src="//qualitifashion.com/cdn/shop/files/Black-Color-4.webp?v=1741287346&width=533"
                                                            sizes="(min-width: 1200px) 267px, (min-width: 990px) calc((100vw - 130px) / 4), (min-width: 750px) calc((100vw - 120px) / 3), calc((100vw - 35px) / 2)"
                                                            alt="Pakistani Herringbone Cotton Fabric Panjabi"
                                                            class="motion-reduce"
                                                            loading="lazy"
                                                            width="700"
                                                            height="800"
                                                        ...
                                                        <img
                                                            srcset="
                                                                //qualitifashion.com/cdn/shop/files/dark-purple-1.webp?v=1741287358&width=165 165w,
                                                                //qualitifashion.com/cdn/shop/files/dark-purple-1.webp?v=1741287358&width=360 360w,
                                                                //qualitifashion.com/cdn/shop/files/dark-purple-1.webp?v=1741287358&width=533 533w,
                                                                //qualitifashion.com/cdn/shop/files/dark-purple-1.webp?v=1741287358           700w
                                                            "
                                                            src="//qualitifashion.com/cdn/shop/files/dark-purple-1.webp?v=1741287358&width=533"
                                                            sizes="(min-width: 1200px) 267px, (min-width: 990px) calc((100vw - 130px) / 4), (min-width: 750px) calc((100vw - 120px) / 3), calc((100vw - 35px) / 2)"
                                                            alt=""
                                                            class="motion-reduce"
                                                            loading="lazy"
                                                ...
                                                <div class="card__content">
                                                    <div class="card__information">
                                                        <h3 class="card__heading">
                                                            <a
                                                                href="/products/pakistani-herringbone-cotton-fabric-panjabi"
                                                                id="StandardCardNoMediaLink-template--17918930681993__featured_collection-8023939842185"
                                                                class="full-unstyled-link"
                                                                aria-labelledby="StandardCardNoMediaLink-template--17918930681993__featured_collection-8023939842185 NoMediaStandardBadge-template--17918930681993__featured_collection-8023939842185"
                                                            >
                                                                Pakistani Herringbone Cotton Fabric Panjabi
                                                            </a>
                                                        </h3>
                                                    </div>
                                                    <div class="card__badge bottom left">
                                                        <span id="NoMediaStandardBadge-template--17918930681993__featured_collection-8023939842185" class="badge badge--bottom-left color-scheme-4">Sale</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card__content">
                                                <div class="card__information">
                                                    <h3 class="card__heading h5" id="title-template--17918930681993__featured_collection-8023939842185">
                                                        <a
                                                            href="/products/pakistani-herringbone-cotton-fabric-panjabi"
                                                            id="CardLink-template--17918930681993__featured_collection-8023939842185"
                                                            class="full-unstyled-link"
                                                            aria-labelledby="CardLink-template--17918930681993__featured_collection-8023939842185 Badge-template--17918930681993__featured_collection-8023939842185"
                                                        >
                                                            Pakistani Herringbone Cotton Fabric Panjabi
                                                        </a>
                                                    </h3>
                                                ...
                                                <div class="card__badge bottom left"><span id="Badge-template--17918930681993__featured_collection-8023939842185" class="badge badge--bottom-left color-scheme-4">Sale</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li id="Slide-template--17918930681993__featured_collection-3" class="grid__item scroll-trigger animate--slide-in" data-cascade style="--animation-order: 3;">
                                    <div class="card-wrapper product-card-wrapper underline-links-hover">
                                        <div class="card card--standard card--media" style="--ratio-percent: 125%;">
                                            <div class="card__inner color-scheme-2 gradient ratio" style="--ratio-percent: 125%;">
                                                <div class="card__media">
                                                    <div class="media media--transparent media--hover-effect">
                                                        <img
                                                            srcset="
                                                                //qualitifashion.com/cdn/shop/files/Black.jpg?v=1740401774&width=165  165w,
                                                                //qualitifashion.com/cdn/shop/files/Black.jpg?v=1740401774&width=360  360w,
                                                                //qualitifashion.com/cdn/shop/files/Black.jpg?v=1740401774&width=533  533w,
                                                                //qualitifashion.com/cdn/shop/files/Black.jpg?v=1740401774&width=720  720w,
                                                                //qualitifashion.com/cdn/shop/files/Black.jpg?v=1740401774&width=940  940w,
                                                                //qualitifashion.com/cdn/shop/files/Black.jpg?v=1740401774           1024w
                                                            "
                                                            src="//qualitifashion.com/cdn/shop/files/Black.jpg?v=1740401774&width=533"
                                                            sizes="(min-width: 1200px) 267px, (min-width: 990px) calc((100vw - 130px) / 4), (min-width: 750px) calc((100vw - 120px) / 3), calc((100vw - 35px) / 2)"
                                                        ...
                                                        <img
                                                            srcset="
                                                                //qualitifashion.com/cdn/shop/files/White.jpg?v=1740401952&width=165  165w,
                                                                //qualitifashion.com/cdn/shop/files/White.jpg?v=1740401952&width=360  360w,
                                                                //qualitifashion.com/cdn/shop/files/White.jpg?v=1740401952&width=533  533w,
                                                                //qualitifashion.com/cdn/shop/files/White.jpg?v=1740401952&width=720  720w,
                                                                //qualitifashion.com/cdn/shop/files/White.jpg?v=1740401952&width=940  940w,
                                                                //qualitifashion.com/cdn/shop/files/White.jpg?v=1740401952           1023w
                                                            "
                                                            src="//qualitifashion.com/cdn/shop/files/White.jpg?v=1740401952&width=533"
                                                            sizes="(min-width: 1200px) 267px, (min-width: 990px) calc((100vw - 130px) / 4), (min-width: 750px) calc((100vw - 120px) / 3), calc((100vw - 35px) / 2)"
                                                            alt=""
                                                            class="motion-reduce"
                                                            loading="lazy"
                                                ...
                                                <div class="card__content">
                                                    <div class="card__information">
                                                        <h3 class="card__heading">
                                                            <a
                                                                href="/products/premium-micro-stich-panjabi"
                                                                id="StandardCardNoMediaLink-template--17918930681993__featured_collection-7999306039433"
                                                                class="full-unstyled-link"
                                                                aria-labelledby="StandardCardNoMediaLink-template--17918930681993__featured_collection-7999306039433 NoMediaStandardBadge-template--17918930681993__featured_collection-7999306039433"
                                                            >
                                                    ...
                                                    <div class="card__badge bottom left">
                                                        <span id="NoMediaStandardBadge-template--17918930681993__featured_collection-7999306039433" class="badge badge--bottom-left color-scheme-4">Sale</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card__content">
                                                <div class="card__information">
                                                    <h3 class="card__heading h5" id="title-template--17918930681993__featured_collection-7999306039433">
                                                        <a
                                                            href="/products/premium-micro-stich-panjabi"
                                                            id="CardLink-template--17918930681993__featured_collection-7999306039433"
                                                            class="full-unstyled-link"
                                                            aria-labelledby="CardLink-template--17918930681993__featured_collection-7999306039433 Badge-template--17918930681993__featured_collection-7999306039433"
                                                        >
                                                            Premium Micro Stich Panjabi
                                                        </a>
                                                    </h3>
                                                ...
                                                <div class="card__badge bottom left"><span id="Badge-template--17918930681993__featured_collection-7999306039433" class="badge badge--bottom-left color-scheme-4">Sale</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </li>
